        ...
        <div className="flex min-h-screen flex-col items-center justify-center bg-slate-900 p-4 sm:p-6 md:p-8">
            <div className="w-full max-w-md rounded-2xl bg-white p-6 sm:p-8 shadow-2xl">
                <div className="mb-6 sm:mb-8 text-center">
                    <h1 className="text-2xl sm:text-3xl font-bold text-gray-900">NodePay Admin</h1>
                    <p className="mt-2 text-sm sm:text-base text-gray-600">Acceso restringido para personal autorizado</p>
                </div>
                <button
                    onClick={login}
