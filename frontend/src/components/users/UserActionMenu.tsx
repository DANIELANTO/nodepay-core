            ...
            {open && (
                <div className="fixed z-50 mt-1 w-52 rounded-xl border border-gray-100 bg-white py-1 shadow-xl">
                    ...
                    <Link
                        ...
                        className="flex items-center gap-3 px-4 py-2.5 text-sm text-gray-700 transition-colors hover:bg-gray-200 hover:cursor-pointer"
                    >
                    ...
                    <Link
                        ...
                        state={{ user }}
                        onClick={() => setOpen(false)}
                        className="flex w-full items-center gap-3 px-4 py-2.5 text-sm text-gray-700 transition-colors hover:bg-gray-200 hover:cursor-pointer"
                    >
                        <svg className="h-4 w-4 text-gray-500" fill="none" stroke="currentColor" strokeWidth={2} viewBox="0 0 24 24">
                    ...
                    <button
                        ...
                        className={`flex w-full items-center gap-3 px-4 py-2.5 text-sm font-medium transition-colors hover:bg-gray-200 hover:cursor-pointer ${user.isActive ? 'text-red-600' : 'text-green-600'
                            }`}
                    >
